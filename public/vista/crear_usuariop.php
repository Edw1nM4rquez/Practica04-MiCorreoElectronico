...
<body>
        ...
        <form id="formulario01" action="../controladores/crear_usuario.php" method="POST"
...
..." onkeypress="ValidarLetras(event,'mensajeApellidos',this)" />
                ...
                <input type="text" id="direccion" name="direccion" value="" placeholder="&#x1F3C3;&#x200D;&#x2642;&#xFE0F;Ingrese su dirección ..." />
                <br>
...
..." onkeypress="ValidarTelefono(event,'mensajeTelefono',this)" />
                ...
                <input type="date" id="fechaNacimiento" name="fechaNacimiento" value="" placeholder="&#128118;Ingrese su fecha de nacimiento ..." onkeypress="validarFecha(event, 'mensajeFecha',this)" />
                <br>
